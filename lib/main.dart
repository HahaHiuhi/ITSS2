        ...
        child: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.check_box, color: Color(0xFF3525CD)),
              label: 'Tasks',
            ),
            NavigationDestination(
              icon: Icon(Icons.calendar_month_outlined),
              selectedIcon:
                  Icon(Icons.calendar_month, color: Color(0xFF3525CD)),
              label: 'Calendar',
            ),
            NavigationDestination(
              icon: Icon(Icons.menu_book_outlined),
              selectedIcon: Icon(Icons.menu_book, color: Color(0xFF3525CD)),
              label: 'Subjects',
            ),
            NavigationDestination(
